...
:switch-case-N-2
    echo tu as tape %choice% %~1
    SET /P page = Taper le numero des pages que vous souhaitez extraire, suivi d'un espace entre chaque :
    START %cd%\PdfMerger.exe -p %~1 -o e -pg %page%
    goto :switch-case-end 

:switch-case-N-3
    echo tu as tape %choice% %~1
    SET /P page = Taper le numero des pages que vous souhaitez supprimer, suivi d'un espace entre chaque : 
